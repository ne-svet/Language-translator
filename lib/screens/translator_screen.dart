...
import '../model/sign_user_methods.dart';
...
class _TranslatorScreenState extends State<TranslatorScreen> {
  //обращение к классу TranslationLogic
  late TranslationLogic translationLogic;

  //обращение к классу Authentication
  late Authentication authentication;

  //контроллер введенного текста
  TextEditingController languageController = TextEditingController();

  //для того, чтобы убрать клавиатуру при щелканьи на свободную область
          ...
          onPressed: () {
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                ...
                margin:
                    const EdgeInsets.symmetric(vertical: 100.0, horizontal: 25),
